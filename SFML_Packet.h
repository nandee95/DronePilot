...
public:
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Tell the upcoming string's length
    ///
    /// This function returns the upcoming string's
    /// length for memory allocation.
    ///
    /// \return Upcoming string's length
    ///
    /// \see operator >> char*
    ///
    ////////////////////////////////////////////////////////////
    Uint32 nextStringLen();
...
private:
    ...
    // Member data
    ////////////////////////////////////////////////////////////
    char*                m_data; ///< Data stored in the packet
    size_t                m_size; ///< Data stored in the packet
    size_t       m_readPos; ///< Current reading position in the packet
    size_t       m_sendPos; ///< Current send position in the packet (for handling partial sends)
